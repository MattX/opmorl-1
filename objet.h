...
int find_near_free_tile(int * posx, int * posy); /* Trouve la case libre la plus proche de *posx, *posy (celle-ci comprise) et met ses coordonnées dans *posx, *posy */ /*retourne 1 si objet droppé, 0 sinon*/